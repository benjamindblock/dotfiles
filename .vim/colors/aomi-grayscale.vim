...
let s:fg_comment   = " " .s:vmode ."fg=" .s:comment
let s:fg_string    = " " .s:vmode ."fg=" .s:string
...
let s:comment   = s:fmt_none .s:fg_comment   .s:bg_none
