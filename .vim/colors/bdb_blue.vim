...
let g:colors_name='bdb_blue'

set background=dark

" colors ----------------------------------------------------------------------

hi Cursor           ctermbg=7    ctermfg=NONE cterm=NONE           guibg=#efefef  guifg=NONE     gui=NONE

hi Normal           ctermbg=0    ctermfg=7    cterm=NONE           guibg=#24364b  guifg=#efefef  gui=NONE
hi Title            ctermbg=NONE ctermfg=7    cterm=NONE  guibg=NONE     guifg=#efefef  gui=NONE
hi Comment          ctermbg=NONE ctermfg=8    cterm=NONE           guibg=NONE     guifg=#A2A2A2  gui=NONE
hi String           ctermbg=NONE ctermfg=8    cterm=NONE           guibg=NONE     guifg=#6194ba  gui=NONE
hi SpecialComment   ctermbg=NONE ctermfg=12   cterm=NONE           guibg=NONE     guifg=#9fcce7  gui=NONE
hi Todo             ctermbg=NONE ctermfg=4    cterm=NONE  guibg=NONE     guifg=#65baf5  gui=NONE
...
hi VertSplit        ctermbg=NONE ctermfg=8    cterm=NONE           guibg=#37407B  guifg=#37407B  gui=NONE
...
hi Pmenu            ctermbg=7    ctermfg=0    cterm=NONE           guibg=#efefef  guifg=#24364b  gui=NONE
hi PmenuSel         ctermbg=0    ctermfg=12   cterm=REVERSE        guibg=#24364b  guifg=#9fcce7  gui=REVERSE
hi PmenuSbar        ctermbg=7    ctermfg=NONE cterm=NONE           guibg=#efefef  guifg=NONE     gui=NONE
hi PmenuThumb       ctermbg=8    ctermfg=NONE cterm=NONE           guibg=#395679  guifg=NONE     gui=NONE
...
hi ErrorMsg         ctermbg=1    ctermfg=7    cterm=NONE           guibg=#e76d6d  guifg=#efefef  gui=NONE
...
hi TabLine          ctermbg=8    ctermfg=0    cterm=NONE           guibg=#284568  guifg=#e4e4dd  gui=NONE
hi TabLineSel       ctermbg=0    ctermfg=12   cterm=REVERSE        guibg=#24364b  guifg=#9fcce7  gui=REVERSE
hi TabLineFill      ctermbg=8    ctermfg=0    cterm=NONE           guibg=#395679  guifg=#24364b  gui=NONE
