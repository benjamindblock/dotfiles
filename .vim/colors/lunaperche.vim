...
if &background ==# 'dark'
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#000000', '#af5f5f', '#5faf5f', '#af875f', '#5f87af', '#d787d7', '#5fafaf', '#ffffff', '#767676', '#ff5f5f', '#5fd75f', '#ffd787', '#5fafff', '#ff87ff', '#5fd7d7', '#ffffff']
  endif
  hi Normal guifg=#ffffff guibg=#000000 gui=NONE cterm=NONE
  hi Statusline guifg=#ffffff guibg=#000000 gui=bold,reverse cterm=bold,reverse
...
" Color: colorMP                 #C5E7C5        30             darkcyan
" Color: colorPMenuSel           #ffffff        251            darkcyan
