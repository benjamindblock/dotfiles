...
function! s:Hi(group, fg_name, bg_name, gui, ...)
  ...
  exe 'hi ' . a:group . ' guifg=' . fg . ' guibg=' . bg . ' cterm=' . style . ' guisp=' . sp
endfunction
...
Hi CursorLine NONE cursor NONE
Hi CursorLineNR black cursor bold
...
" Custom MatchWork
hi MatchWord guifg=blue cterm=underline

hi StatusLine guifg=#000000 guibg=#b2b2b2 gui=bold cterm=bold
hi StatusLineNC guifg=#000000 guibg=#dbd7d3 gui=NONE cterm=NONE
